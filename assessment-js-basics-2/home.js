...
// //logs You're in our delivery zone!
// console.log(canWeDeliver(70508))
// //logs Sorry, we can't deliver to that address
...
const canWeDeliverTwo = (zipCode) =>{
    for (zipCode in deliveryAreaZipCodes === true){
        return `You're in our delivery zone!`
    } 
    for (zipCode in deliveryAreaZipCodes === false){
        return `Sorry, we can't deliver to that address`
    }   
    }
